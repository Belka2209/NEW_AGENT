...
5. В чате агента можно просить любой сайт, не только Bitrix и hh.ru.

Если обычный веб-поиск ничего не нашёл, агент сам открывает тот же запрос в Chrome (Яндекс). Можно сразу: «найди в браузере …».
